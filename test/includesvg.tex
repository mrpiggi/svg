...
%\begin{figure}
%  \centering
%  \includesvg[svgpath=bar/,width=.2\textwidth]{example_bar}
%  \includesvg[width=.4\textwidth]{Bild}\par  
  \newincludesvg[.2\textwidth]{example}
  
  \newincludesvg[.2\textwidth]{example_bar}
  
  \newincludesvg[.2\textwidth]{example_foo}
