...
%\IfFileExists{xr.sty}{jepp}{nope}
%
%\svg@IfFileExists{xr.sty}{jepp}{nope}
%
%\begingroup%
%  \svg@set@input@path
%  \svg@IfFileExists{C:/Users/Hanisch/none.jpg}{\meaning\@filef@und}{nope}
%  
%  \svg@IfFileExists{xr.sty}{\meaning\@filef@und}{nope}
%  
%  \svg@IfFileExists{svg-example.svg}{\meaning\@filef@und}{nope}
%  
...
%\begingroup%
%%  \svg@set@input@path
%  \IfFileExists{ svg example.foo.svg}{\meaning\@filef@und}{nope}%
%  
%  \svg@IfFileExists{ svg example.foo.svg}{\meaning\@filef@und}{nope}%
%\endgroup
%
%\bigskip
%
%\svg@IfFileExists{ "test ink "/svg example.foo .svg" 
%}{\meaning\@filef@und}{xx}%
%
%\svg@IfFileExists{test ink/svg example.foo .svg}{\meaning\@filef@und}{xx}%
%
%\bigskip
