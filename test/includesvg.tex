...
\svgpath{{testink}{"test ink"}}

\begin{document}
%\newcommand\testiffile[2]{%
%\def\bla##1{%
%%  \svg@sanitize@dq\xxx@tempa{##1}%
%  \edef\xxx@tempa{##1}%
%  \texttt{\xxx@tempa}: \IfFileExists{\xxx@tempa}{jepp}{nope}\newline
%}
%
%\bla{#1.#2}
%\bla{./#1.#2}
...
%\bigskip
%
%\testiffile{bar.foo}{baz}
%
%\testiffile{bar foo}{baz}
%
%\testiffile{Ordner/bar.foo}{baz}
%
%\testiffile{Ordner/bar foo}{baz}
%
%\testiffile{Neuer Ordner/bar.foo}{baz}
%
%\testiffile{Neuer Ordner/bar foo}{baz}
%\end{document}
...
\includesvg[
  lastpage=1,
  extract=forced,convert=forced,extractformat={bar,baar,bla,eps,ps},
